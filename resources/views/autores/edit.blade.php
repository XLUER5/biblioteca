...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Editar Autor') }}</div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nombre_completo" type="text"
                                    ...
                                    name="nombre_completo" value="{{ old('nombre_completo', $autor->nombre_completo) }}"
                                    required autofocus>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_nacimiento" type="date"
                                    ...
                                    value="{{ old('fecha_nacimiento', $autor->fecha_nacimiento) }}" required>
